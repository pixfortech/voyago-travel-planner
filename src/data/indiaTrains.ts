...
export const INDIA_TRAINS: IndiaTrainData[] = [
  ...
  // Flagship, long-stable Konkan services. Route codes are public/stable;
  // times are APPROXIMATE (see file header) — verify on NTES/IRCTC.
  {
    trainNumber: '10103',
    trainName: 'Mandovi Express',
    routeStationCodes: ['CSMT', 'PNVL', 'RN', 'KKW', 'THVM', 'KRMI', 'MAO'],
    routeDescription: 'Mumbai CSMT → Madgaon',
    fromStationCode: 'CSMT',
    toStationCode: 'MAO',
    departureTime: '07:10',
    arrivalTime: '18:50',
    arrivalDayOffset: 0,
    reverseTrainNumber: '10104',
    daysOfRun: 'Daily',
    trainType: 'mail_express',
  ...
  },
  {
    trainNumber: '10104',
    trainName: 'Mandovi Express',
    routeStationCodes: ['MAO', 'KRMI', 'THVM', 'KKW', 'RN', 'PNVL', 'CSMT'],
    routeDescription: 'Madgaon → Mumbai CSMT',
    fromStationCode: 'MAO',
    toStationCode: 'CSMT',
    departureTime: '09:30',
    arrivalTime: '21:55',
    arrivalDayOffset: 0,
    reverseTrainNumber: '10103',
    daysOfRun: 'Daily',
    trainType: 'mail_express',
    classes: ['1A', '2A', '3A', 'SL', '2S'],
    pantry: true,
  ...
  },
  {
    ...
    shortName: 'Jan Shatabdi',
    routeStationCodes: ['DR', 'PNVL', 'RN', 'KKW', 'THVM', 'KRMI', 'MAO'],
    routeDescription: 'Dadar → Madgaon',
    fromStationCode: 'DR',
    toStationCode: 'MAO',
    departureTime: '05:50',
    arrivalTime: '13:35',
    arrivalDayOffset: 0,
    reverseTrainNumber: '12052',
    daysOfRun: 'Daily except Tue',
    trainType: 'superfast',
    classes: ['CC', '2S'],
    pantry: true,
    source: 'local_seed',
  ...
  {
    trainNumber: '12052',
    trainName: 'Madgaon Dadar Jan Shatabdi Express',
    shortName: 'Jan Shatabdi',
    routeStationCodes: ['MAO', 'KRMI', 'THVM', 'KKW', 'RN', 'PNVL', 'DR'],
    routeDescription: 'Madgaon → Dadar',
    fromStationCode: 'MAO',
    toStationCode: 'DR',
    departureTime: '14:30',
    arrivalTime: '22:15',
    arrivalDayOffset: 0,
    reverseTrainNumber: '12051',
    daysOfRun: 'Daily except Tue',
    trainType: 'superfast',
    classes: ['CC', '2S'],
    pantry: true,
